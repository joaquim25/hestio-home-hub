...
const mockConversations = [
  {
    ...
    role: 'Inquilino',
    property: 'T2 Chiado',
    lastMessage: 'Obrigado pela rápida resposta!',
    timestamp: '10:30',
    unread: 0,
    online: true,
    type: 'tenant',
  },
  {
    ...
    role: 'Inquilina',
    property: 'T3 Cascais',
    lastMessage: 'A renda foi transferida hoje.',
    timestamp: 'Ontem',
    unread: 1,
    online: false,
    type: 'tenant',
  },
  {
    ...
    name: 'Pedro Costa',
    role: 'Agente',
    lastMessage: 'Tenho um potencial inquilino para o T1.',
    timestamp: '15 Dez',
    unread: 2,
    online: true,
    type: 'agent',
  },
  {
    ...
    name: 'TecniServ',
    role: 'Manutenção',
    lastMessage: 'Orçamento enviado para aprovação.',
    timestamp: '14 Dez',
    unread: 1,
    online: false,
    type: 'vendor',
...
const mockMessages = [
  {
    id: '1',
    senderId: 'other',
    content: 'Bom dia! A torneira da casa de banho está a pingar.',
    timestamp: '09:15',
  },
  {
    id: '2',
    senderId: 'me',
    content: 'Bom dia João! Obrigada por avisar. Vou contactar o canalizador.',
    timestamp: '09:30',
  },
  {
    id: '3',
  ...
  },
  {
    id: '4',
    senderId: 'me',
    content: 'Sim, o técnico vai amanhã entre as 10h e as 12h.',
    timestamp: '10:00',
  },
  {
    id: '5',
    senderId: 'other',
    content: 'Obrigado pela rápida resposta!',
    timestamp: '10:30',
  },
];
    ...
    <>
      <div className="mb-6">
        ...
        <p className="text-muted-foreground mt-1">
          Comunique com inquilinos, agentes e prestadores de serviços
        </p>
      </div>
          ...
          <div className="p-4 border-b space-y-3">
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab}>
              <TabsList className="w-full">
                ...
                <TabsTrigger value="agent" className="flex-1">Agentes</TabsTrigger>
              </TabsList>
            </Tabs>
          </div>
