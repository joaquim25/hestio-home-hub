  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-hero text-primary-foreground shadow-lg hover:shadow-glow hover:-translate-y-1 active:translate-y-0 font-semibold",
        ...
        accent: "bg-accent text-accent-foreground shadow-md hover:bg-accent/90 hover:shadow-accent-glow hover:-translate-y-0.5",
